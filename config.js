module.exports = {
  ...
  // i.e: "-spidey bot foo" will trigger the command "foo",
  //      whereas "Spidey Bot foo" will do nothing at all.
  prefix:  "-spidey bot",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "kU1A9EH57FLDLDiWfukn-fkKz0aRLkcoXP75L1yJfxf5xgfSUBycD_ZbLjOLfp5QQlu5",
